...
class RecipeReviewCard extends React.Component<Props&{data: IResource}, State> {
  ...
  download = async () => {
    await downloadResource(this.props.data.id)
  }
    ...
    return (
      <Card className={classes.card} style={{marginTop: '2rem', width: '100%'}}>
        ...
        <CardActions className={classes.actions} disableActionSpacing>
          <IconButton aria-label="下载" onClick={this.download}>
            <DownloadIcon />
          </IconButton>
